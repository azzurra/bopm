/*
 * NOTE: The author's site (http://www.ijs.si/software/snprintf/) states that
 * this software may be used under the terms of the GNU General Public License
 * and so that is what we shall be doing.  This is the same license as the rest
 * of libopm and BOPM.
 *
...
#else
/* declare our portable routines under names libopm_snprintf and libopm_vsnprintf */
#define portable_snprintf libopm_snprintf
#if !defined(NEED_SNPRINTF_ONLY)
#define portable_vsnprintf libopm_vsnprintf
#endif
#endif
