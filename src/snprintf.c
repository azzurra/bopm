...
#else
/* declare our portable routines under names bopm_snprintf and bopm_vsnprintf */
#define portable_snprintf bopm_snprintf
#if !defined(NEED_SNPRINTF_ONLY)
#define portable_vsnprintf bopm_vsnprintf
#endif
#endif
